...
- **多轮实跑回归修正**：按真实聊天导出逐图核对，收敛了人数 tag、动作词照抄与绑定写法、锚点来源、建档字段、同人 tag 形态、`size` 词不进 tag 串等一批问题，并定下「人数只用 danbooru 标准词、on 只许接穿戴件与解剖部位、单人画面不许写 looking at another、规范里的举例一律是占位不许照抄」。逐轮结论见 [DESIGN.md](./DESIGN.md) §0.3～§0.8。
